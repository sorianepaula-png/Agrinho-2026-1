...
const niveisEducacionais = {
    1: [
        ...
        },
        {
            ...
            opcoes: [
                "Porque o fogo mata os microorganismos bons e empobrece a terra",
                "Porque a fumaça atrapalha o crescimento das frutas",
                "Porque o fogo deixa o solo muito úmido",
                "Porque as cinzas azedam as sementes"
            ],
            correta: 0,
            materialId: "cartilha-solo",
        ...
        },
        {
            ...
            opcoes: [
                ...
                "Porque altera as plantas hospedeiras e quebra o ciclo biológico da praga",
    ...
    2: [
        ...
        },
        {
            ...
            correta: 1,
            materialId: "cartilha-solo",
            dica: "Dica: Plantas capturam o CO2 da atmosfera e o fixam em forma de matéria orgânica."
        },
        {
    ...
    3: [
        ...
        {
            pergunta: "Para medir a vazão de uma mina recuperada, o método correto Corretamente envolve:",
            opcoes: [
...
document.addEventListener('DOMContentLoaded', () => {
    // Configura o ouvinte reativo do simulador
    ...
    // Inicialização da Trilha do Quiz
...
function calcularMetricasSimulador() {
    ...
    let vCultivo = solo === 'alto' ? 100 : (solo === 'medio' ? 60 : 20);
    let vAmbiental = agua === 'alto' ? 100 : (agua === 'medio' ? 50 : 10);
    let vGestao = insumos === 'alto' ? 100 : (insumos === 'medio' ? 60 : 30);

    if (biodiversidade === 'alto') {
        vAmbiental = Math.min(vAmbiental + 10, 100);
...
function salvarTentativaNoHistorico() {
    ...
    let historico = JSON.parse(localStorage.getItem('historico_agrinho_raizes')) || [];
    historico.push(novaNota);
    localStorage.setItem('historico_agrinho_raizes', JSON.stringify(historico));
